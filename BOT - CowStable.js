            ...
            Player.Description = `
                    ....... automated ServiceBot model "CowStable" 0.0.0.1 .......
                        Sandras Cow Farm
                        =================
            ...
            function commandHandler(sender, msg) {
                ...
                if (msg.toLowerCase().includes("milk ")) {
                    console.log("You are suggsted to be milked from " + sender.MemberNumber)
                    checkGuest(sender)
                ...
                if (msg.toLowerCase().includes("info")) {
                    ...
                    mess = mess + "*--------------------"
                    if (isCow(sender.MemberNumber))
                        mess = mess + nl + "There are " + game.cowCount() + " cow"
                    else
            ...
            function prepareCow(sender, char, playerList, newCows) {
               ...
               InventoryWear(char, "兽蹄鞋_Luzi","Shoes",dressColor)
                ...
                //?? Not Working                
                InventoryWear(char, "JewelrySet","Jewelry","Default")
             ...
             //               InventoryGet(char, "ItemNipples").Property = { Mode: "Random", Intensity: 1, Effect: ["Egged", "Vibrating"] }
                ...
                // InventoryWear(char, "Ears","CowEars",dressColor)
